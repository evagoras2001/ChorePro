...
<html lang="en">
  ...
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.4.1/css/all.css" integrity="sha384-5sAR7xN1Nv6T6+dT2mhtzEpVJvfS3NScPQTrOxhwjIuvcA67KV2R5Jz6kr4abQsz" crossorigin="anonymous">
    <title>ChorePro Add chore</title>
  </head>
  <body id="body">
    <div class="container">
      <nav class="navbar">
      ...
      <main>
        <div class="main__container">
          ...
          <p class="descriptions">Add a <strong>Chore</strong></p><br>

          <div class="main__cards">
            <?php echo $choresuccess;?>
            <?php echo $form; ?>
            <?php echo $taskerror; ?>
            <?php echo $taskempty; ?>

            <?php echo $form1; ?>
            <?php echo $discriptionempty; ?>
            ...
            <?php echo $form4; ?>
            <?php echo $neededempty; ?>
            <?php echo $needederror; ?>
            <?php echo $form5; ?>
