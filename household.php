...
<html lang="en">
  ...
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.4.1/css/all.css" integrity="sha384-5sAR7xN1Nv6T6+dT2mhtzEpVJvfS3NScPQTrOxhwjIuvcA67KV2R5Jz6kr4abQsz" crossorigin="anonymous">
    <title>ChorePro Household Assinged Chores</title>
  </head>
  <body id="body">
    <div class="container">
      <nav class="navbar">
      ...
      <main>
        <div class="main__container">
          ...
          <p class="descriptions">Household's <strong>Chores</strong>:</p><br>

                    <div class="main__cards">
                      <?php echo $active;?>
                    </div>

                    <p class="descriptions">Household's completed <strong>Chores</strong>:</p><br>
